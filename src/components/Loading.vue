...
<script>
  export default {
    ...
    methods:{
      _setHeight(){
        var footerH = document.querySelector('#my-footer').clientHeight;
        var headerH = document.querySelector('.my-header').clientHeight;
        var loadDom = document.querySelector('.loader');
        var winH = document.documentElement.clientHeight;
        loadDom.style.height = winH - footerH - headerH - 20 + 'px';
      }
    }
  }
</script>
